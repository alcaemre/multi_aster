...
# Last Modified: 2026/06/30 15:37:22
#
...
# exp_dir = f'{ceph}multi_aster/dt-L/two_aster_14_spindle_length_10000_tubulin_0.002_temp/'
...
spindle.animate_mtoc_trajectory(save_path=ani_path, interval=50, stride=800, show_occupancy=True, occupancy_mtoc_id=1)